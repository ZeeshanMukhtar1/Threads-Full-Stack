    ...
    <Flex flexDirection={'column'}>
      <Flex gap={3} my={2} onClick={(e) => e.preventDefault()}>
        <svg
          ...
          viewBox="0 0 24 22"
          width="20"
          color={liked ? 'rgb(237,73,86)' : ''} // Change the color based on the liked state
          fill={liked ? 'rgb(237,73,86)' : 'transparent'} // Change the fill based on the liked state
          onClick={handleLikeAndUnlike} // Toggle the liked state
        >
          <path
